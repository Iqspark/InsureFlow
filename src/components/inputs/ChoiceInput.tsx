    ...
    >
      {options.map((opt) => (
        <button
          ...
          className={`group flex flex-col items-start gap-0.5 px-4 py-3 bg-white border-2 rounded-xl text-left transition-all duration-150 hover:border-indigo-400 hover:shadow-md hover:bg-indigo-50 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-indigo-300 ${
