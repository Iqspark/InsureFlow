    ...
    <div className="flex-1 p-4 sm:p-6 lg:p-8 overflow-auto">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
          <p className="text-xs text-slate-500 uppercase tracking-wide mb-1">Total Policies</p>
          <p className="text-3xl font-bold text-slate-900">{total}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
          <p className="text-xs text-slate-500 uppercase tracking-wide mb-1">Accepted</p>
          <p className="text-3xl font-bold text-emerald-600">{accepts}</p>
        </div>
        <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm col-span-2 sm:col-span-1">
          <p className="text-xs text-slate-500 uppercase tracking-wide mb-1">This Month</p>
          <p className="text-3xl font-bold text-indigo-600">{thisMonth}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <Link
          href="/new-quote"
          className="flex items-center justify-center gap-2 px-5 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-colors shadow-sm text-sm"
        >
