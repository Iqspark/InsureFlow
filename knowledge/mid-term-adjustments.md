...
## What is "pro-rata" and how is the difference charged?
Only the **unused part of the term** is adjusted. The change in annual premium is multiplied by the remaining days divided by the full term:
- If the premium goes **up**, the customer owes an **additional premium** (AP) for the remaining days.
- If the premium goes **down**, the customer receives a **return premium** (RP) for the remaining days.

For example, a $1,050 annual increase with 28 of 365 days left is an additional premium of about $81.

## Does the customer get notified?
Yes. When an adjustment is confirmed, the customer is emailed a confirmation showing the old and new coverage and premium and the pro-rata additional or return premium. The broker can open the sent confirmation from the success message.

## Where can I see past adjustments?
...
## How is an adjustment different from a renewal or cancellation?
- **Adjustment** — changes the policy mid-term; the term and policy continue.
- **Renewal** — a new 12-month term at the end of the current one.
- **Cancellation** — ends the policy mid-term (a short-rate refund may apply). See "Cancellations & Refunds."
